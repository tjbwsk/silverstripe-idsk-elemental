<% with $Form %>
	...
	<div id="idsk-footer-extended-feedback-content"<% if $FormName && not $isValid %> class=" idsk-footer-extended-feedback-content"<% end_if %>>
		<div class="govuk-width-container">
			<div class="govuk-grid-row">
						...
						<div class="govuk-grid-column-full">
							<div class="idsk-footer-extended-feedback-question-container">
								<div class="govuk-grid-column-two-thirds idsk-footer-extended-help-form-header-mobile">
									<h3 class="govuk-heading-x">$Top.SurveyTitle</h3>
								</div>
							...
							<div class="idsk-footer-extended-feedback-button">
								<% with $Top.SurveyAction %>
									<% if $Me %>
										<% include Rasstislav/IdSk/Includes/Components/Button Title=$Title, Link=$LinkURL, TargetBlank=$OpenInNewWindow, ButtonID='fill-feedback-help-form' %>
									<% end_if %>
								<% end_with %>
							</div>
						</div>
				...
				<div id="idsk-footer-extended-error-form" class="idsk-footer-extended-feedback-hidden <% if $FormName && not $isValid %>idsk-footer-extended-open<% else %>idsk-footer-extended-display-hidden<% end_if %>">
					<div class="idsk-footer-extended-feedback-container">
						<div class="govuk-grid-column-full">
							<div class="idsk-footer-extended-feedback-question-container">
								<div class="govuk-grid-column-two-thirds idsk-footer-extended-help-form-header-mobile">
									<h3 class="govuk-heading-x">$Top.FeedbackTitle</h3>
								</div>
								<div class="govuk-grid-column-one-third idsk-footer-extended-close-button-mobile">
